...
*/
  ...
  $s_id = isset($_SESSION['id']) ? $_SESSION['id'] : "id-undefine";
	$sql = "select img_profile from customers where id = '$s_id'";
	//echo $sql;
	...
	if ( $result->num_rows > 0) {
	 //lay link anh tu csdl da luu de hien thi cac anh duoc luu trong uploads
	  ...
	  echo '<img style="width: 200px; height: 200px;   "src="'.'./uploads/'.$row['img_profile'].'" alt="Anh profile">';
	}
	?>
